...
class QuorumIntersectionCheckerImpl : public digitalbits::QuorumIntersectionChecker
{
    ...
    // reporting.
    mutable std::pair<std::vector<digitalbits::PublicKey>,
                      std::vector<digitalbits::PublicKey>>
        mPotentialSplit;
    ...
    std::vector<digitalbits::PublicKey> mBitNumPubKeys;
    std::unordered_map<digitalbits::PublicKey, size_t> mPubKeyBitNums;
    QGraph mGraph;
  ...
  public:
    ...
    std::pair<std::vector<digitalbits::PublicKey>, std::vector<digitalbits::PublicKey>>
